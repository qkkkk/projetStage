...
<form class="form-horizontal" action ="../entreprise/php de modification stage.php" method="post">
    <div class="container">
        <h2>Detail votre depot de stage no.<?php echo $data['id_stage'], $data['titre'] ;?></h2>
        </br>
        <div class="col-md-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $data['nom_type_traveaux'];?>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <button type="submit" name= "annuler"  class="btn btn-default">retourner</button>
                </div>
